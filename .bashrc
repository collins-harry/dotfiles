...
# \e[ tells bash it's color info, \m signifies the end of color tag
# 8bit
# \[{typeface};{color}m\]
# typeface: 0 - normal, 1 - bold, 2 - dim, 4 - underlined
...
# Create full prompt
FULLPS1="$PromptRangerLvl$PromptLFLvl$PromptK8Namespace$PromptCondaEnv$PromptNodeVersion$PromptUser $PromptCWD$PromptGit$PromptEnd"
PS1="$FULLPS1"
