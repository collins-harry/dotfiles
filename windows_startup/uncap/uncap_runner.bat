...
:: Run as admin
Powershell -Command "& Start-Process \"%USERPROFILE%\dotfiles\windows_startup\uncap\uncap.exe\" -ArgumentList @(\"0x1B:0x14\", \"0x14:0x1B\") -Verb RunAs"

:: Run as normal user
%USERPROFILE%\dotfiles\windows_startup\uncap\uncap.exe 0x1B:0x14 0x14:0x1B
